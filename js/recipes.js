export const recipes = [
  ...
  },
  {
    ...
    time: 50,
    description: 'Faire cuire le riz. Une fois le riz cuit, le laisser refroidir. Couper les oeufs durs en quarts ou en lamelles au choix, coupez les tomates en dés, ajoutez au riz les oeufs, les tomates, le poisson, le maïs et la vinaigrette. Ajouter au gout de chacun des cornichons, olives etc...',
  ...
  },
  {
    ...
    appliance: 'Four',
    utensils: ['Moule à gâteaux', 'Rouleau à patisserie', 'Fouet']
  },
  {
    id: 24,
  ...
  },
  {
    ...
    time: 25,
    description: "Verser de l'huile dans une cocotte minute couper les légumes et les verser dans l'huile chaude. Laisser cuire et remuer pendant 10 minutes. Passer au mixer. Servir.",
    appliance: 'Mixer',
  ...
  },
  {
    ...
    time: 60,
    description: "Découper en cubes les carottes et pommes de terre. Faire revenir dans du beurre. Ajouter les lardons, une fois les lardons dorés, ajouter un grand verre d'eau. Ajouter les petit poids et les haricots verts ( tous deux pré cuits ). Ajouter sel, poivre, thym et laurier.",
    appliance: 'Poêle',
    utensils: ['Couteau', 'Économe']
  },
  {
    ...
    time: 20,
    description: "Beurrer les tranches de pain, ajouter entre 2 tranches de pain de mie 1 tranche d'émental, une de blanc de dinde, et une autre d'emmental. Dans un récipient, mélanger le gruyère rappé avec le lait et la noix de muscade. Mettre sur les croque monsieur. Placer au four durant 10 minutes.",
    appliance: 'Four',
